...
/*public class LineComprison {

    public static void main(String[] args) {
        System.out.print("Welcome to the Line Comparison Problem");
    }
*/
...
public class LineComprison {
    public static void main(String[] args) {
        ...
        System.out.println("Length of a line is " + LineComprison.lengthOfLine(x1, x2, y1, y2));
        i.close();
    }
